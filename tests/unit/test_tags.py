...
def scope_class():
    ...
    main.app.dependency_overrides[get_tag_service] = get_tag_memory_service
    yield
    ...
    main.app.dependency_overrides[get_tag_memory_service] = get_tag_service
